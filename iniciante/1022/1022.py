...
#que contém a expressão a ser lida é: 
...
#No caso de não ser possível uma simplificação, deve ser apresentada a mesma resposta 
...
# um inteiro N (1 ≤ N ≤ 1*104), indicando a quantidade de casos de teste que devem 
# ser lidos logo a seguir. Cada caso de teste contém um valor racional X (1 ≤ X ≤ 1000), 
...
# outro valor racional, que é a simplificação do primeiro valor. 
# No caso do primeiro valor não poder ser simplificado, o mesmo deve ser repetido após 
